...
HD_PWD='C:/Users/elena/OneDrive/Escritorio/LAVADORAv4/project_2/project_2.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log Lavadora.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lavadora.tcl -notrace
