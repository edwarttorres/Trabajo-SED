...
HD_PWD='C:/Users/elena/OneDrive/Escritorio/LAVADORAv4/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lavadora.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lavadora.tcl
